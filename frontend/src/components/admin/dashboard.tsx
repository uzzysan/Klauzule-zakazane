        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            {user.is_reviewer && !user.is_admin && (
              <span className="rounded bg-secondary px-2 py-0.5 text-xs">Recenzent</span>
            )}
          </div>
      ...
      <div className="mb-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">analiz do przejrzenia</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {isLoadingMetrics ? "..." : metrics.length > 0 ? metrics[0]?.total_reviews || 0 : 0}
            </div>
            <p className="text-xs text-muted-foreground">przesłanych dzisiaj</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">ostatnie dane</p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Wydajność systemu wykrywania klauzul niedozwolonych</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Ostatnio zakończone analizy wymagające weryfikacji</CardDescription>
          </CardHeader>
          <CardContent>
            <PendingReviewsList
