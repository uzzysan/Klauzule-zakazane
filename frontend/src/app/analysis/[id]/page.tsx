        ...
        <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a href="https://suppi.pl/rafcio" target="_blank" rel="noopener noreferrer">
            <Button variant="outline" className="gap-2 hover:bg-secondary/80">
              <Heart className="h-4 w-4 fill-rose-500/10 text-rose-500" />
              Wspieram to co robisz
            </Button>
          </a>
        </div>

        <h1 className="mb-2 text-3xl font-bold">Wyniki analizy</h1>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Klauzule potencjalnie niedozwolone w dokumencie</CardDescription>
            </div>
