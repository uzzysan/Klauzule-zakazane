...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "default_risk_level IN ('high', 'medium', 'low')", name="valid_risk_level"
        ),
        sa.ForeignKeyConstraint(
            ["parent_category_id"],
            ["clause_categories.id"],
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "risk_level IN ('high', 'medium', 'low')", name="valid_clause_risk_level"
        ),
        sa.CheckConstraint(
            "source IN ('standard', 'user', 'community', 'imported')", name="valid_clause_source"
        ),
        sa.CheckConstraint(
            "confidence >= 0.0 AND confidence <= 1.0", name="valid_clause_confidence"
        ),
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["clause_categories.id"],
    ...
    op.create_index(
        op.f("ix_prohibited_clauses_user_id"), "prohibited_clauses", ["user_id"], unique=False
    )
    op.create_table(
        "clause_legal_references",
        ...
        sa.ForeignKeyConstraint(
            ["legal_reference_id"], ["legal_references.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "risk_level IN ('high', 'medium', 'low')", name="valid_flagged_risk_level"
        ),
        sa.CheckConstraint(
            "confidence >= 0.0 AND confidence <= 1.0", name="valid_flagged_confidence"
        ),
